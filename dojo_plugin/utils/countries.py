COUNTRIES = dict(
    ...
    BM="Bermuda", BT="Bhutan", BO="Bolivia", BA="Bosnia & Herzegovina", BW="Botswana", BR="Brazil",
    IO="British Indian Ocean Territory", VG="British Virgin Islands", BN="Brunei", BG="Bulgaria",
    BF="Burkina Faso", BI="Burundi", KH="Cambodia", CM="Cameroon", CA="Canada", IC="Canary Islands",
    CV="Cape Verde", BQ="Caribbean Netherlands", KY="Cayman Islands", CF="Central African Republic",
    EA="Ceuta & Melilla", TD="Chad", CL="Chile", CN="China", CX="Christmas Island",
    CC="Cocos (Keeling) Islands", CO="Colombia", KM="Comoros", CG="Congo - Brazzaville",
    CD="Congo - Kinshasa", CK="Cook Islands", CR="Costa Rica", CI="Côte d’Ivoire", HR="Croatia", CU="Cuba",
    CW="Curaçao", CY="Cyprus", CZ="Czechia", DK="Denmark", DG="Diego Garcia", DJ="Djibouti", DM="Dominica",
    DO="Dominican Republic", EC="Ecuador", EG="Egypt", SV="El Salvador", GQ="Equatorial Guinea",
    ER="Eritrea", EE="Estonia", ET="Ethiopia", EZ="Eurozone", FK="Falkland Islands", FO="Faroe Islands",
    ...
    HK="Hong Kong SAR China", HU="Hungary", IS="Iceland", IN="India", ID="Indonesia", IR="Iran", IQ="Iraq",
    IE="Ireland", IM="Isle of Man", IL="Israel", IT="Italy", JM="Jamaica", JP="Japan", JE="Jersey",
    JO="Jordan", KZ="Kazakhstan", KE="Kenya", KI="Kiribati", XK="Kosovo", KW="Kuwait", KG="Kyrgyzstan",
    LA="Laos", LV="Latvia", LB="Lebanon", LS="Lesotho", LR="Liberia", LY="Libya", LI="Liechtenstein",
    LT="Lithuania", LU="Luxembourg", MO="Macau SAR China", MK="Macedonia", MG="Madagascar", MW="Malawi",
    ...
    MN="Mongolia", ME="Montenegro", MS="Montserrat", MA="Morocco", MZ="Mozambique", MM="Myanmar (Burma)",
    ...
    SL="Sierra Leone", SG="Singapore", SX="Sint Maarten", SK="Slovakia", SI="Slovenia", SB="Solomon Islands",
    SO="Somalia", ZA="South Africa", GS="South Georgia & South Sandwich Islands", KR="South Korea",
    SS="South Sudan", ES="Spain", LK="Sri Lanka", BL="St. Barthélemy", SH="St. Helena",
    KN="St. Kitts & Nevis", LC="St. Lucia", MF="St. Martin", PM="St. Pierre & Miquelon",
    VC="St. Vincent & Grenadines", SD="Sudan", SR="Suriname", SJ="Svalbard & Jan Mayen", SZ="Swaziland",
    SE="Sweden", CH="Switzerland", SY="Syria", TW="Taiwan", TJ="Tajikistan", TZ="Tanzania", TH="Thailand",
    TL="Timor-Leste", TG="Togo", TK="Tokelau", TO="Tonga", TT="Trinidad & Tobago", TA="Tristan da Cunha",
