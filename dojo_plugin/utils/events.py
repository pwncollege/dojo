...
def publish_dojo_stats_event(dojo_id_int):
    return publish_stat_event("dojo_stats_update", {"dojo_id": dojo_id_int})
...
def publish_scores_event(dojo_id=None):
    ...
    return publish_stat_event("scores_update", payload)


def publish_belts_event():
    return publish_stat_event("belts_update", {})


def publish_emojis_event():
    return publish_stat_event("emojis_update", {})


def publish_activity_event(user_id):
    return publish_stat_event("activity_update", {"user_id": user_id})
...
def publish_challenge_solve_event(user_id, challenge_id, solve_date=None):
    ...
    return publish_stat_event("challenge_solve", payload)
