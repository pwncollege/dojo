...
function startChallenge(event) {
    ...
    CTFd.fetch('/pwncollege_api/v1/docker', {
        ...
        if (result.success) {
            var message = `Challenge successfully started! You can interact with it through a <a href="/workspace/vscode">VSCode Workspace</a> or a <a href="/desktop">GUI Desktop</a>.`;
