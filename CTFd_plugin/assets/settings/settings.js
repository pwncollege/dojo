                ...
                response.json().then(function(object) {
                    if (!object.success) {
                        Object.keys(object.errors).map(function(error) {
                            ...
                            var alert = key_error_template.format(error_msg);
                            console.log(key_error_template);
                            $("#key-results").append(alert);
                        });
                    }
                });
