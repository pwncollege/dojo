...
from utils import TEST_DOJOS_LOCATION, DOJO_URL, login, make_dojo_official, create_dojo, create_dojo_yml, solve_challenge_offline, remove_workspace_container, remove_workspace_home, wait_for_background_worker, db_sql, dojo_db_id, suppress_award_popup
from selenium.webdriver import Firefox, FirefoxOptions
from tiers import MULTINODE_TESTS, TEST_FILE_TIERS, TEST_TIER_OVERRIDES
...
def pytest_collection_modifyitems(items):
    for item in items:
        ...
        if test_key in MULTINODE_TESTS:
