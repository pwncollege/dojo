...
export function useChallengeDescription(
	...
	return useQuery({
		...
		queryFn: () =>
			dojoService.getChallengeDescription(dojoId, moduleId, challengeId),
...
export function useChallengeSurvey(
	...
	return useQuery({
		...
		queryFn: () =>
			dojoService.getChallengeSurvey(dojoId, moduleId, challengeId),
		enabled: enabled && !!dojoId && !!moduleId && !!challengeId,
...
export function useSubmitChallengeSolution() {
	...
	return useMutation({
		mutationFn: ({
			...
			dojoService.submitChallengeSolution(
				dojoId,
				moduleId,
				challengeId,
				submission,
...
export function useSubmitSurveyResponse() {
	...
	return useMutation({
		...
		onSuccess: (_, variables) => {
			...
			queryClient.invalidateQueries({
				queryKey: queryKeys.challengeSurvey(
					variables.dojoId,
					variables.moduleId,
